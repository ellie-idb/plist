...
<plist version="1.0">
    <true/>
        ...
        assert(b.value, "Expected boolean to be true");
        b.value = false;
        assert(!b.value, "Expected boolean to be false");
    }
    /* Test if it can be false, too */
    {
        string xml = `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
    ...
    /* Since this is an empty tag, we will convert it to it's proper form (same test, except with false)*/
    {
        string xml = `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
